...
| :--- | :--- | :--- |
| **Top-1 Exact Match Accuracy** | 2.27% | 0.15% |
| **Top-3 Any Match Accuracy** | N/A | 0.45% |
| **F1 Score (Micro)** | 0.0570 | 0.1272 |
| **F1 Score (Macro)** | 0.0569 | 0.0969 |
| **Precision (Micro)** | 0.22 | 0.11 |
| **Recall (Micro)** | 0.03 | 0.15 |
